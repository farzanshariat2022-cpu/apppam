        ...
        builder: (context, snapshot) {
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                const Text('کلید Gemini API',
                    style: TextStyle(color: AppColors.textPrimary, fontWeight: FontWeight.bold, fontSize: 16)),
                const SizedBox(height: 8),
                const Text(
                  'برای فعال شدن تحلیل هوشمند روزانه، چت، تصمیم‌گیری، ژورنال هوشمند و گزارش ماهانه، '
                ...
                ElevatedButton(
                  onPressed: _saving
                      ...
                      : () async {
                          ...
                          await _firestoreService.saveGeminiApiKey(uid, _apiKeyController.text.trim());
