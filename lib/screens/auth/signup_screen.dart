...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _handleSignup() async {
    ...
    final error =
        await auth.signUp(_emailController.text.trim(), _passwordController.text.trim(), _nameController.text.trim());
    if (!mounted) return;
    setState(() {
      _loading = false;
      _error = error;
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                TextField(controller: _nameController, decoration: const InputDecoration(hintText: 'نام')),
