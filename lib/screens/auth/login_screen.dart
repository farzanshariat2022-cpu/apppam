              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.architecture, color: Colors.black, size: 34),
                  ),
                  const SizedBox(height: 20),
                  const Text('ورود به معمار',
                  ...
                  TextButton(
                    ...
                    child: const Text('حساب نداری؟ ثبت‌نام کن', style: TextStyle(color: AppColors.textSecondary)),
                  ),
                ],
              ),
            ),
